...
$string['pluginname'] = 'Form Google Search';
$string['google_search_form:addinstance'] = 'Add a new Form Google Search block';
$string['google_search_form:myaddinstance'] = 'Add a new Form Google Search block to the My dashboard';
